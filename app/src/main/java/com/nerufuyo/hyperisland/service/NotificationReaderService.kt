...
import com.nerufuyo.hyperisland.MainActivity
...
import com.nerufuyo.hyperisland.data.theme.RulesEngine
import com.nerufuyo.hyperisland.data.theme.ThemeRepository
import com.nerufuyo.hyperisland.data.widget.WidgetManager
import com.nerufuyo.hyperisland.models.ActiveIsland
import com.nerufuyo.hyperisland.models.HyperIslandData
import com.nerufuyo.hyperisland.models.IslandConfig
import com.nerufuyo.hyperisland.models.IslandLimitMode
import com.nerufuyo.hyperisland.models.NavContent
import com.nerufuyo.hyperisland.models.NotificationType
import com.nerufuyo.hyperisland.models.WidgetConfig
import com.nerufuyo.hyperisland.models.WidgetRenderMode
import com.nerufuyo.hyperisland.service.translators.CallTranslator
import com.nerufuyo.hyperisland.service.translators.LiveUpdateTranslator
import com.nerufuyo.hyperisland.service.translators.MediaTranslator
import com.nerufuyo.hyperisland.service.translators.MessageTranslator
import com.nerufuyo.hyperisland.service.translators.NavTranslator
import com.nerufuyo.hyperisland.service.translators.ProgressTranslator
import com.nerufuyo.hyperisland.service.translators.DownloadTranslator
import com.nerufuyo.hyperisland.service.translators.StandardTranslator
...
class NotificationReaderService : NotificationListenerService() {
    ...
    private val islandClickReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            if (intent.action == "com.nerufuyo.hyperisland.ISLAND_CLICKED") {
                ...
                if (originalIntent != null) {
                    try {
                        ...
                        Log.e("HyperIsland", "PendingIntent canceled", e)
                    }
                }
    ...
    private suspend fun processStandardNotification(rawSbn: StatusBarNotification) {
        ...
        try {
            ...
            if (useLiveUpdates) {
                ...
                val hasPermission = com.nerufuyo.hyperisland.util.XiaomiNotificationHelper.hasFocusPermission(this)
                if (!hasPermission && com.nerufuyo.hyperisland.util.XiaomiNotificationHelper.isSupportIsland()) {
                    serviceScope.launch {
        ...
        if (!hasPermission) {
            ...
            sbn.notification.contentIntent?.let { originalIntent ->
                if (detectNotificationType(sbn) == NotificationType.MESSAGE) {
                    val clickIntent = Intent("com.nerufuyo.hyperisland.ISLAND_CLICKED").apply {
    ...
    override fun onListenerConnected() { 
        Log.i(TAG, "HyperIsland Service Connected")
        syncNotifications(refresh = true)
        syncJob?.cancel()
