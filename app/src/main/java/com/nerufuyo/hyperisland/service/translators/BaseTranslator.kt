package com.nerufuyo.hyperisland.service.translators
...
import com.nerufuyo.hyperisland.models.BridgeAction
import com.nerufuyo.hyperisland.models.theme.ActionButtonMode
...
import com.nerufuyo.hyperisland.ui.screens.theme.getShapeFromId
...
abstract class BaseTranslator(
    ...
    protected fun extractBridgeActions(
        ...
        config: com.nerufuyo.hyperisland.models.IslandConfig,
        ...
        actions.forEachIndexed { index, androidAction ->
            ...
            val finalIntent = if (hasRemoteInput) {
                if (config.enableInlineReply != false) {
                    val replyIntent = android.content.Intent(context, com.nerufuyo.hyperisland.receiver.InlineReplyReceiver::class.java).apply {
