...
import com.nerufuyo.hyperisland.util.parseBold
        ...
        Column(
            ...
            SettingsSection(
                ...
                items = listOf(
                    ...
                    SettingsItemData(Icons.Default.Person, stringResource(R.string.developer), stringResource(R.string.developer_subtitle)) { uriHandler.openUri("https://github.com/nerufuyo") },
                    SettingsItemData(Icons.Default.History, stringResource(R.string.version_history), "0.1.0 - $appVersion", onHistoryClick),
                    SettingsItemData(Icons.Default.Code, stringResource(R.string.source_code), stringResource(R.string.source_code_subtitle)) { uriHandler.openUri("https://github.com/nerufuyo/hyper-island") },
